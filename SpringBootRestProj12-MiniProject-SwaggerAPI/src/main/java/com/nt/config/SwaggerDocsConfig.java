...
@Configuration //how to make it configuration class . ... by using @Configuration	
@EnableSwagger2
public class SwaggerDocsConfig {
	@Bean
	 public   Docket createDocket() {
		   return  new Docket(DocumentationType.SWAGGER_2)  //UI screen type
				              .select()  //to specify  RestControllers...what class you want to apply
				              ...
				              .build() // builds the Docket obj		//Generally people code upto this others are extra info
