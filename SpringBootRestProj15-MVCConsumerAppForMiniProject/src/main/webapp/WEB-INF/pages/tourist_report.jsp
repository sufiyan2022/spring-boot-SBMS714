...
<h1 style="color:red;text-align:center">The Tourist Info</h1>
...
<c:otherwise>
<h1 style="color:red;text-align:center">Tourist not found</h1>
</c:otherwise>

</c:choose>
<br>
<h2 style="text-align:center"><a href="addz">Add Tourist</a></h2>
