...
public class ActorOperationsController {
	...
	public ResponseEntity<Actor> searchActor(){
		return new ResponseEntity<Actor>(new Actor(999, "Salman", 50.0f, "hero"),HttpStatus.OK);
	}
	
	@GetMapping("/findAll")
	public ResponseEntity<List<Actor>> fetchAllActors(){
		return new ResponseEntity<List<Actor>>(List.of(new Actor(101, "Salman", 40.0f, "hero"),
																										new Actor(102, "Aman", 30.0f, "hero")),
																										HttpStatus.OK);
	}
